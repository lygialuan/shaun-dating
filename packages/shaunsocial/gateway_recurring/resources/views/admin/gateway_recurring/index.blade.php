...
<div class="admin-card has-table">
    <div class="admin-card-top">
        <h5 class="admin-card-top-title">{{__('Gateway Recurring')}}</h5>
    </div>    
            ...
            <tbody id="gateway_list">
                ...
                <tr data-id="{{$gateway->id}}">
                    ...
                    <td class="actions-cell">
                        <a class="admin_modal_ajax" href="javascript:void(0);" data-url="{{route('admin.gateway_recurring.edit',$gateway->id)}}">{{__('Edit')}}</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
...
<script>
    adminGateway.initListing('{{route('admin.gateway_recurring.store_order')}}')
</script>
@endpush