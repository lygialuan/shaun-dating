...
<section class="modal-card-body">        
    <div class="card-content">
        <form id="gateway_form" method="post" action="{{ route('admin.gateway_recurring.store')}}" onsubmit="return false;">
            <div id="errors"></div>
            {{ csrf_field() }}
            ...
            @includeIf('shaun_gateway_recurring::admin.partial.gateway_recurring.'.$gateway->key, ['config' => $gateway->getConfig()])
