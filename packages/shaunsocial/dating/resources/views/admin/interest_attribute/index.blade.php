...
<div class="admin-card has-table">
    <div class="admin-card-top">
        ...
        <a 
            ...
            data-url="{{route('admin.dating.interest_attribute.create')}}" 
                    ...
                    @foreach ($attributes as $attribute)
                        <tr data-id="{{$attribute->id}}">
                            ...
                            <td class="actions-cell" width="200">
                                <a class="admin_modal_ajax" href="javascript:void(0)" data-url="{{route('admin.dating.interest_attribute.create', $attribute->id)}}">
                                    {{__('Edit')}}
                                </a>
                                <a href="{{route('admin.dating.interest_attribute.value', $attribute->id)}}">
                                    {{__('Manage Values')}}
                                </a>
                                <a class="button-red admin_modal_confirm_delete" href="javascript:void(0)" data-url="{{route('admin.dating.interest_attribute.delete',$attribute->id)}}">
                                    {{__('Delete')}}
                                </a>
                            </td>
                        </tr>
...
<script>
    adminDating.initAttributesList('{{route('admin.dating.interest_attribute.store_order')}}');
</script>
@endpush