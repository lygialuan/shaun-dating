...
<div class="admin-card has-table">
    <div class="admin-card-top">
        ...
        <a 
            ...
            data-url="{{route('admin.dating.attribute.value.create', ['attribute_id' => $attributeId])}}" 
    ...
    <div class="admin-card-body table-responsive">
        <form id="listing_tag_form" method="POST" action="{{route('admin.dating.attribute.value.store_manage')}}">
            {{ csrf_field() }}
                    ...
                    <tr>
                        ...
                        <td class="actions-cell" width="150">
                            <a 
                                ...
                                href="javascript:void(0)" 
                                data-url="{{route('admin.dating.attribute.value.create',['id' => $attributeValue->id, 'attribute_id' => $attributeId])}}"
                            >
                                {{__('Edit')}}
                            </a>
                            <a 
                                ...
                                href="javascript:void(0)" 
                                data-url="{{route('admin.dating.attribute.value.delete',['id' => $attributeValue->id, 'attribute_id' => $attributeId])}}"
                            >
                                {{__('Delete')}}
                            </a>
                        </td>
