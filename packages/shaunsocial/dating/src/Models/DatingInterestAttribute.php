...
class DatingInterestAttribute extends Model
{
    use HasCacheQueryFields, HasTranslations, HasStorageFiles;

    public static $cachePermanentKey = 'dating_interest_attributes';
    ...
    {
        return 'interest_attributes_' . $categoryId;
    }

    public static function getCacheAttributeValuesName($attributeId)
    {
        return "interest_attribute_values_{$attributeId}";
    }
    ...
    public static function getAttributeValues($attributeId)
    {
        return Cache::remember(
            ...
            function () use ($attributeId) {
                return DatingInterestAttributeValue::where('attribute_id', $attributeId)
                    ->get();
            }
        );
    }
    ...
    public static function getListAttributeCacheName($ids)
    {
        ...
        return "get_list_interest__attribute_{$idsStr}";
    }
