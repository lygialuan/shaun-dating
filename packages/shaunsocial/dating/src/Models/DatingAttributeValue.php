...
class DatingAttributeValue extends Model
{
    ...
    public static function getAttributeValuesByIds($ids)
    {
        ...
        return Cache::remember(
            "cache_attribute_values_by_ids_{md5($strIds)}",
    ...
    {
        return Cache::remember(
            "cache_check_tag_exists_{$name}_id_{$attributeId}",
    ...
    public function cloneValue($attributeId) {
        $newValue = DatingAttributeValue::create([
            'name' => $this->name,
