<div class="form-group">
    ...
    <input class="form-control" name="config[api_key]" value="{{ $config['api_key'] ?? '' }}" type="password" placeholder="xai-...">
    <small class="form-text text-muted">{{ __('Enter your xAI API key') }}</small>
</div>
...
<div class="form-group">
    ...
    <input
        ...
        name="config[model]"
        value="{{ $config['model'] ?? '' }}"
        placeholder="ex: grok-beta, grok-pro"
        autocomplete="off">
