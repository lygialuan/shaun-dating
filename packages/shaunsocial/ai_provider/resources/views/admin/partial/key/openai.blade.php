<div class="form-group">
    ...
    <input class="form-control" name="config[api_key]" value="{{ $config['api_key'] ?? '' }}" type="password" placeholder="sk-...">
    <small class="form-text text-muted">{{ __('Enter your OpenAI API key') }}</small>
</div>
