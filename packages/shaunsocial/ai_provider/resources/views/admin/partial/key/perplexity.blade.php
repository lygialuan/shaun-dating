<div class="form-group">
    ...
    <input class="form-control" name="config[api_key]" value="{{ $config['api_key'] ?? '' }}" type="password" placeholder="pplx-...">
    <small class="form-text text-muted">{{ __('Enter your Perplexity API key') }}</small>
</div>
