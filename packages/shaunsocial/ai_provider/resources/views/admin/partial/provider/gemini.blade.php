<div class="form-group">
    ...
    <input
        ...
        autocomplete="off">
    <small class="form-text text-muted">{{ __('Used when new keys omit a specific model.') }}</small>
</div>
...
<div class="form-group">
    <label class="control-label">{{ __('Default Max Output Tokens') }}</label>
    ...
    <small class="form-text text-muted">{{ __('Fallback limit for model responses.') }}</small>
</div>
