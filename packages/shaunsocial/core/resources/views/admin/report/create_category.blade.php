...
<section class="modal-card-body">        
    <div class="card-content">
        <form id="report_category_form" method="post" action="{{ route('admin.report.store_category')}}" onsubmit="return false;">
            <div id="errors">
            </div>
            {{ csrf_field() }}
...
<footer class="modal-card-foot">
    <button class="btn-filled-blue" id="report_category_submit">{{__('Submit')}}</button>
    <button class="btn-filled-white modal-close">{{__('Cancel')}}</button>
</footer>
<script>
    adminReport.initCreateCategory();
</script>