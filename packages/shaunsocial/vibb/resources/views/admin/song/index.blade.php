...
<div class="admin-card has-table">
    <div class="admin-card-top">
        <h5 class="admin-card-top-title">{{__('Vibb Songs')}}</h5>
        <a class="button admin_modal_ajax btn-filled-blue" data-url="{{route('admin.vibb.song.create')}}" href="javascript:void(0);">{{__('Create new')}}</a>
    </div>
    <form method="get">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions-cell" width="150">
                        <a class="admin_modal_ajax" href="javascript:void(0);" data-url="{{route('admin.vibb.song.create',$song->id)}}">
                            {{__('Edit')}}
                        </a>
                        <a class="button-red admin_modal_confirm_delete" href="javascript:void(0);" data-url="{{route('admin.vibb.song.delete',$song->id)}}">
                            {{__('Delete')}}
                        </a>
                    </td>
                </tr>
...
@push('scripts-body')
<script src="{{ asset('admin/js/vibb.js') }}"></script>
<script src="{{ asset('admin/js/lib/Sortable.min.js') }}"></script>
<script>
    adminVibb.initSongListing();
</script>
@endpush