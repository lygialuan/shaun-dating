...
<div class="admin-card has-table">
    <div class="admin-card-top">
        <h5 class="admin-card-top-title">{{__('Group Categories')}}</h5>
        <a class="button admin_modal_ajax btn-filled-blue" data-url="{{route('admin.group.category.create')}}" href="javascript:void(0);">{{__('Create new')}}</a>
    </div>
    <div class="admin-card-body">
        <div class="admin-menu-table">
            ...
            <div class="admin-menu-table-body" id="group_categories_list">
                ...
                <div class="admin-menu-table-body-wrap" data-id="{{ $category->id }}">
                    <div class="admin-menu-table-body-row">
                        ...
                        <div class="actions-cell admin-menu-table-col admin-menu-table-col-action">
                            <a class="admin_modal_ajax" href="javascript:void(0)" data-url="{{route('admin.group.category.create',$category->id)}}">
                                {{__('Edit')}}
                            </a>
                            <a class="button-red admin_modal_confirm_delete" data-url="{{route('admin.group.category.delete',$category->id)}}">
                                {{__('Delete')}}
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="menu_child admin-menu-table-body-wrap" id="menu_child_{{ $category->id }}">                                       
                            @foreach ($category->childs as $child)
                                <div class="admin-menu-table-body-row" data-id="{{ $child->id }}">
                                    ...
                                    <div class="actions-cell admin-menu-table-col admin-menu-table-col-action">
                                        <a class="admin_modal_ajax" href="javascript:void(0)" data-url="{{route('admin.group.category.create',$child->id)}}">
                                            {{__('Edit')}}
                                        </a>
                                        <a class="button-red admin_modal_confirm_delete" href="javascript:void(0)" data-url="{{route('admin.group.category.delete',$child->id)}}">
                                            {{__('Delete')}}
                                        </a>
                                    </div>
                                </div>
...
<script>
    adminGroup.initCategoriesList('{{route('admin.group.category.store_order')}}');
</script>
@endpush